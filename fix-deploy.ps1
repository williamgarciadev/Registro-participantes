# Script para reparar y redeployar despues del error de CloudWatch Logs
# Ejecuta este script en PowerShell

Write-Host "============================================"
Write-Host "Iniciando reparacion del deploy..."
Write-Host "============================================"
Write-Host ""

# Paso 1: Eliminar el stack fallido
Write-Host "PASO 1: Eliminando stack fallido..."
Write-Host "Escribe 'y' cuando se te pida confirmacion"
Write-Host ""
