...
- [ ] Backend - Endpoints y proteccion: exponer rutas de autenticacion (`/auth/login`, `/auth/profile`), sembrar o documentar un usuario admin base, aplicar dependencias de autorizacion segun rol sobre los endpoints de participantes.
